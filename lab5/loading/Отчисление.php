...
<html style="font-size: 16px;" lang="ru"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Вы уверенны?">
    <meta name="description" content="">
    <title>Отчисление</title>
    <link rel="stylesheet" href="../css/nicepage1.css" media="screen">
<link rel="stylesheet" href="../css/Отчисление.css" media="screen">
    ...
    <meta property="og:title" content="Отчисление">
  ...
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="ru"><header class="u-clearfix u-header u-header" id="sec-30bc"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-section-1" id="sec-e4d8">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-text u-text-default u-text-1">Вы уверенны?</h1>


          <?php

          ?>
        <a href="delete.php" class="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-10 u-btn-1">Подтвердить</a>
      </div>
    </section>
