...
<div id="container">
    ...
    <form id="form" method="POST">
        ...
        <select name="number">
            <opttion selected value="0">Номер группы</opttion>
        <?php
        $group = mysqli_query($connect, 'SELECT * FROM `group`');
        ...
        ?>
            ...
            <option value="<?=$group1[3] ?>"><?=$group1[3] ?></option>
            <?php
        }
            ?>
        </select>
        ...
        <br><br>
        <input type="" name="fullname" placeholder="Ф.И.О." required>
        <br>
...
<script type="text/javascript">
    $("#form").submit(function (e) { // Устанавливаем событие отправки для формы с id=form
        ...
        $.ajax({
            ...
            url: "student.php", // Путь до php файла отправителя
            data: form_data,
            success: function () {
